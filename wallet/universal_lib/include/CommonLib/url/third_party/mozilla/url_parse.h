...
void ParseStandardURL(const char* url,
                                 int url_len,
                                 Parsed* parsed);
void ParseStandardURL(const base::char16* url,
                                 int url_len,
                                 Parsed* parsed);
...
void ParseFileURL(const base::char16* url,
                             int url_len,
                             Parsed* parsed);
...
void ParseMailtoURL(const base::char16* url,
                               int url_len,
                               Parsed* parsed);
...
bool ExtractScheme(const char* url,
                              int url_len,
                              Component* scheme);
bool ExtractScheme(const base::char16* url,
                              int url_len,
                              Component* scheme);
