...
public:
	...
	void Init(UINT nFlags, HWND hWnd, UINT nIDTool = 0, LPRECT lpRect = NULL, LPTSTR lpstrText = LPSTR_TEXTCALLBACK, LPARAM lUserParam = NULL)
	{
		...
		// TODO: 解决 tooltip addtool 失败的问题，原要求定义 _WIN32_WINNT=0x0500 WangZhan
#ifdef _WIN32_TOOLTIP_BUGFIX
...
// Attributes
	...
	std::wstring GetItemText(int nItem, int nSubItem) const
	{
		ATLASSERT(::IsWindow(m_hWnd));
		LVITEM lvi = { 0 };
		lvi.iSubItem = nSubItem;
