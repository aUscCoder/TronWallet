...
{ \
	...
	{ \
		{ sizeof(WNDCLASSEX), 0, StartWindowProc, \
		  0, 0, NULL, NULL, NULL, (HBRUSH)(COLOR_BACKGROUND + 1), NULL, WndClassName, NULL }, \
...
#define DECLARE_FRAME_WND_CLASS_WITH_BRUSH(WndClassName, uCommonResourceID, style, brush) \
static WTL::CFrameWndClassInfo& GetWndClassInfo() \
{ \
	static WTL::CFrameWndClassInfo wc = \
	{ \
...
{ \
	...
	{ \
		{ style, StartWindowProc, \
		0, 0, NULL, NULL, NULL, (HBRUSH)(brush), NULL, WndClassName }, \
		NULL, NULL, IDC_ARROW, TRUE, 0, _T(""), uCommonResourceID \
	}; \
	return wc; \
}
