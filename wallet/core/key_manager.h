...
namespace wallet_core
{
    ...
    */
    ...
    public:
        ...
        bytes encryptUseEncryptedKey(bytesConstRef _v, Address const& _address);
        std::string decryptUseEncryptedKey(bytesConstRef _v, Address const& _address);
        ...
        void clear(Address const& _a);

        static boost::filesystem::path defaultPath() { return getDataDir("tron") / boost::filesystem::path("keys.info"); }
