...
public:
    ...
    bytes encryptUseEncryptedKey(bytesConstRef _v, Address const& _address, std::string const& _pass);
    bytesSec decryptUseEncryptedKey(bytesConstRef _v, Address const& _address, std::string const& _pass);
...
private:
	...
	static std::string encrypt(bytesConstRef _v, std::string const& _pass, KDF _kdf = KDF::PBKDF2_SHA256);
