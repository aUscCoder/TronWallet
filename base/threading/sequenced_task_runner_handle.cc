...
thread_local SequencedTaskRunnerHandle* sequenced_task_runner_tls = nullptr;
...
*/
    return sequenced_task_runner_tls->task_runner_;
  }
/*
...
bool SequencedTaskRunnerHandle::IsSet() {
  return sequenced_task_runner_tls ||
...
SequencedTaskRunnerHandle::SequencedTaskRunnerHandle(
  ...
  sequenced_task_runner_tls = this;
}

SequencedTaskRunnerHandle::~SequencedTaskRunnerHandle() {
  DCHECK(task_runner_->RunsTasksInCurrentSequence());
  DCHECK_EQ(sequenced_task_runner_tls, this);
  sequenced_task_runner_tls = nullptr;
}
