...
// Provides similar functionality as UnicodeString::caseMap but on std::u16string.
std::u16string CaseMap(const std::u16string& string, CaseMapperFunction case_mapper) {
  std::u16string dest;
  if (string.empty())
    return dest;
