...
class ScopedTypeRef {
 public:
  ...
  T* InitializeInto() __attribute__((warn_unused_result)) {
    DCHECK(!object_);
    return &object_;
  }
  ...
  T release() __attribute((ns_returns_not_retained)) __attribute__((warn_unused_result)) {
