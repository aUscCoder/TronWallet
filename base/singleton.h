...
static const std::intptr_t kBeingCreatedMarker = 1;
...
template <typename Type>
std::atomic<int32_t> StaticMemorySingletonTraits<Type>::dead_{0};
...
*/
    ...
    intptr_t old_value = 0;
    if (instance_.compare_exchange_strong(old_value,
      ...
      instance_.store(reinterpret_cast<std::intptr_t>(newval), std::memory_order_release);
/*      
